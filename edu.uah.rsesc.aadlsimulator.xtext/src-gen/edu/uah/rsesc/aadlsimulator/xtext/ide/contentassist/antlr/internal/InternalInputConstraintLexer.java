...
public class InternalInputConstraintLexer extends Lexer {
    ...
    public final void mRULE_BIGDECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2812:17: ( ( '0' .. '9' )* '.' ( '0' .. '9' )+ )
            // InternalInputConstraint.g:2812:19: ( '0' .. '9' )* '.' ( '0' .. '9' )+
            {
            // InternalInputConstraint.g:2812:19: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalInputConstraint.g:2812:20: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            match('.'); 
            // InternalInputConstraint.g:2812:35: ( '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalInputConstraint.g:2812:36: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_TRUE() throws RecognitionException {
        try {
            int _type = RULE_TRUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2814:11: ( 'true' )
            // InternalInputConstraint.g:2814:13: 'true'
            {
            match("true"); 
    ...
    public final void mRULE_FALSE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2816:12: ( 'false' )
            // InternalInputConstraint.g:2816:14: 'false'
            {
            match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2818:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '[' ( '0' .. '9' )+ ']' )* )
            // InternalInputConstraint.g:2818:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* ( '[' ( '0' .. '9' )+ ']' )*
            {
            ...
            // InternalInputConstraint.g:2818:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
            ...
            // InternalInputConstraint.g:2818:69: ( '[' ( '0' .. '9' )+ ']' )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalInputConstraint.g:2818:70: '[' ( '0' .. '9' )+ ']'
            	    {
            	    match('['); 
            	    // InternalInputConstraint.g:2818:74: ( '0' .. '9' )+
            	    int cnt4=0;
            	    loop4:
            	    do {
            	        int alt4=2;
            	        ...
            	        switch (alt4) {
            	    	case 1 :
            	    	    // InternalInputConstraint.g:2818:75: '0' .. '9'
            	    	    {
            	    	    matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2820:10: ( ( '0' .. '9' )+ )
            // InternalInputConstraint.g:2820:12: ( '0' .. '9' )+
            {
            // InternalInputConstraint.g:2820:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalInputConstraint.g:2820:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2822:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalInputConstraint.g:2822:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalInputConstraint.g:2822:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalInputConstraint.g:2822:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalInputConstraint.g:2822:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalInputConstraint.g:2822:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInputConstraint.g:2822:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalInputConstraint.g:2822:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalInputConstraint.g:2822:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalInputConstraint.g:2822:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInputConstraint.g:2822:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2824:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalInputConstraint.g:2824:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalInputConstraint.g:2824:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalInputConstraint.g:2824:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2826:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalInputConstraint.g:2826:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalInputConstraint.g:2826:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
            ...
            // InternalInputConstraint.g:2826:40: ( ( '\\r' )? '\\n' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalInputConstraint.g:2826:41: ( '\\r' )? '\\n'
                    {
                    // InternalInputConstraint.g:2826:41: ( '\\r' )?
                    int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2828:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalInputConstraint.g:2828:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalInputConstraint.g:2828:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInputConstraint.g:2830:16: ( . )
            // InternalInputConstraint.g:2830:18: .
            {
            matchAny(); 
