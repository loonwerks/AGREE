...
public class CreateGuaranteePaletteCommand extends BasePaletteCommand implements TargetedPaletteCommand {
	public CreateGuaranteePaletteCommand() {
		super("Guarantee", AgreePaletteCategories.AGREE, null);
	}
