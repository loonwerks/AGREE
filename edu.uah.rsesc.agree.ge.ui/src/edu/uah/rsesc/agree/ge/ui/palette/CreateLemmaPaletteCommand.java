...
public class CreateLemmaPaletteCommand extends BasePaletteCommand implements TargetedPaletteCommand {
	public CreateLemmaPaletteCommand() {
		super("Lemma", AgreePaletteCategories.AGREE, null);
	}
